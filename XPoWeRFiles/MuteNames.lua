...
if DevAbs:get(XPoWeR.."Abs:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevAbs:sadd(XPoWeR.."Abs:Mute:Names"..msg.chat_id_, MuteName)
end
...
DevAbs:srem(XPoWeR.."Abs:Mute:Names"..msg.chat_id_, UnMuteName)
end
end
if text == "مسح الاسماء المكتومه" and Constructor(msg) then
DevAbs:del(XPoWeR.."Abs:Mute:Names"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "⌁︙تم مسح الاسماء المكتومه")
end
if text == "الاسماء المكتومه" and Constructor(msg) then
local AllNames = DevAbs:smembers(XPoWeR.."Abs:Mute:Names"..msg.chat_id_)
...
if not Manager(msg) and DevAbs:get(XPoWeR.."Abs:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
XPoWeRName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if XPoWeRName then 
XPoWeRNames = DevAbs:smembers(XPoWeR.."Abs:Mute:Names"..msg.chat_id_) or ""
if XPoWeRNames and XPoWeRNames[1] then 
for i=1,#XPoWeRNames do 
if XPoWeRName:match("(.*)("..XPoWeRNames[i]..")(.*)") then 
...
DevAbs:set(XPoWeR.."Abs:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevAbs:del(XPoWeR.."Abs:Lock:MuteNames"..msg.chat_id_)
end
end
end
